...
pub struct Reasoning {
	/// The effort level for reasoning. Supported values: "none", "minimal", "low", "medium", "high", "xhigh".
	#[serde(skip_serializing_if = "Option::is_none")]
	pub effort: Option<String>,
	/// Whether to generate a summary of the reasoning. Supported values: "auto", "concise", "detailed".
	#[serde(skip_serializing_if = "Option::is_none")]
	pub summary: Option<String>,
}
...
// ---------------------
// OpenAI Responses API Streaming Types
// ---------------------

/// A streaming event from the OpenAI Responses API.
/// The `type` field determines which variant this is.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(tag = "type", rename_all = "snake_case")]
pub enum ResponsesStreamEvent {
	/// Emitted when a response is created
	#[serde(rename = "response.created")]
	ResponseCreated { sequence_number: i64, response: serde_json::Value },
	/// Emitted when the response is in progress
	#[serde(rename = "response.in_progress")]
	ResponseInProgress { sequence_number: i64, response: serde_json::Value },
	/// Emitted when the response is completed
	#[serde(rename = "response.completed")]
	ResponseCompleted {
		sequence_number: i64,
		response: ResponsesStreamCompletedResponse,
	},
	/// Emitted when the response fails
	#[serde(rename = "response.failed")]
	ResponseFailed { sequence_number: i64, response: serde_json::Value },
	/// Emitted when a response is incomplete
	#[serde(rename = "response.incomplete")]
	ResponseIncomplete { sequence_number: i64, response: serde_json::Value },
	/// Emitted when a response is queued
	#[serde(rename = "response.queued")]
	ResponseQueued { sequence_number: i64, response: serde_json::Value },
	...
	/// Emitted when there is an annotation added to output text
	...
	/// Emitted when a function call starts
	...
	/// Emitted when a function call is done
	...
	FileSearchCallInProgress { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when a file search is currently searching
	#[serde(rename = "response.file_search_call.searching")]
	FileSearchCallSearching { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when a file search call is completed
	#[serde(rename = "response.file_search_call.completed")]
	FileSearchCallCompleted { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when a web search call is initiated
	#[serde(rename = "response.web_search_call.in_progress")]
	WebSearchCallInProgress { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when a web search call is executing
	#[serde(rename = "response.web_search_call.searching")]
	WebSearchCallSearching { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when a web search call is completed
	#[serde(rename = "response.web_search_call.completed")]
	WebSearchCallCompleted { sequence_number: i64, output_index: i64, item_id: String },
	...
	ImageGenerationCallCompleted { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when an image generation tool call is actively generating
	#[serde(rename = "response.image_generation_call.generating")]
	ImageGenerationCallGenerating { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when an image generation tool call is in progress
	#[serde(rename = "response.image_generation_call.in_progress")]
	ImageGenerationCallInProgress { sequence_number: i64, output_index: i64, item_id: String },
	...
	McpCallCompleted { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when an MCP tool call has failed
	#[serde(rename = "response.mcp_call.failed")]
	McpCallFailed { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when an MCP tool call is in progress
	#[serde(rename = "response.mcp_call.in_progress")]
	McpCallInProgress { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when the list of available MCP tools has been successfully retrieved
	#[serde(rename = "response.mcp_list_tools.completed")]
	McpListToolsCompleted { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when the attempt to list available MCP tools has failed
	#[serde(rename = "response.mcp_list_tools.failed")]
	McpListToolsFailed { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when the system is in the process of retrieving the list of available MCP tools
	#[serde(rename = "response.mcp_list_tools.in_progress")]
	McpListToolsInProgress { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when a code interpreter call is in progress
	#[serde(rename = "response.code_interpreter_call.in_progress")]
	CodeInterpreterCallInProgress { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when the code interpreter is actively interpreting
	#[serde(rename = "response.code_interpreter_call.interpreting")]
	CodeInterpreterCallInterpreting { sequence_number: i64, output_index: i64, item_id: String },
	/// Emitted when the code interpreter call is completed
	#[serde(rename = "response.code_interpreter_call.completed")]
	CodeInterpreterCallCompleted { sequence_number: i64, output_index: i64, item_id: String },
...
/// Response object in the completed event
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResponsesStreamCompletedResponse {
	pub id: String,
	#[serde(default)]
	pub status: Option<String>,
	#[serde(default)]
...
pub struct ResponsesStreamUsage {
	...
	pub output_tokens: u32,
	#[serde(default)]
	pub input_tokens_details: Option<ResponsesStreamInputTokensDetails>,
	#[serde(default)]
	pub output_tokens_details: Option<ResponsesStreamOutputTokensDetails>,
	#[serde(default)]
	pub total_tokens: Option<u32>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResponsesStreamInputTokensDetails {
	#[serde(default)]
	pub cached_tokens: i64,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResponsesStreamOutputTokensDetails {
	#[serde(default)]
	pub reasoning_tokens: i64,
}
